 ...
 *
 * 대시보드 SQL Editor 에 다섯 파일을 순서대로 붙여 넣다 보면 하나를 빠뜨리거나
...
const HEADER = `-- ════════════════════════════════════════════════════════════════
--  0006 ~ 0010 을 한 번에 올리는 파일
--
--  왜 있나 — 다섯 파일을 순서대로 붙여 넣다 보면 하나를 빠뜨리거나 순서가
...
--  네 칸이 모두 이름을 보여 주면 성공이다. null 이 있으면 그 위 오류를 볼 것.
--
